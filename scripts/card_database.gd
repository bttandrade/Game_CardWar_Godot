const CARDS = {
	...
	"hero_knight" : [3, 8, "unit", "*Concede 2 de vida a todos os aliados", "res://scripts/abilities/holy_shield.gd", 4],
	...
	"villain_death" : [2, 6, "unit", "*Destrói qualquer unit que atacar", "res://scripts/abilities/death_touch.gd", 4],
	...
	"pirate_cannon" : [2, 6, "unit", "*Ataca todos os inimigos em campo", "res://scripts/abilities/cannon.gd", 4],
